...
namespace Oculus.Voice.Demo
{
    public class VoiceManager : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            appVoiceExperience.events.OnFullTranscription.AddListener(OnRequestTranscriptFinal);
        ...
        private void OnDisable()
        {
            ...
            appVoiceExperience.events.OnFullTranscription.RemoveListener(OnRequestTranscriptFinal);
        ...
        //When the user is done talking and the transcription has come back
        private void OnRequestTranscriptFinal(string transcript)
        {
            textArea.text = transcript;
            convoManager.UserResponded(transcript);
        }
